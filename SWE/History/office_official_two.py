    ...
    def nextFunction():
        ...
        if name == '' or class_no_temp == '' or r == '' or dat == '' or Office_Area_temp == '' or city_ == '' or street_ == '' or cnumber_temp == '' or postal_code == '' or email_ == '' or Request_Renewing_Year_temp == '' or (ar.get() == 0 and c.get() == 0 and e.get() == 0 and mh.get() == 0):
            ...
            if find == None:
                ...
                messagebox.showerror(title='Invalid input', message='please check your office name number')
                return

            elif find[2] != r:
                messagebox.showerror(title='Invalid input', message='please check your rank')
                return
