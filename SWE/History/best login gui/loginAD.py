...
def set_background_image():
    ...
    image_path = "C:/Users/coldw/Desktop/SWE Final Code/best login gui/pattern.png"  # Replace with the actual path to your PNG image
...
image_path = "C:/Users/coldw/Desktop/SWE Final Code/best login gui/a.png"  # Replace with the actual path to your image
...
user_label = ctk.CTkLabel(master=frame, text='Username')
...
pass_label.grid(row=2, column=0, padx=10)

# Password entry
user_pass = ctk.CTkEntry(master=frame, placeholder_text="Password", show="*")
user_pass.grid(row=2, column=1, padx=10)
